...
public class Square {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A square with side length of " + s.getSide() + " has an area of: " + s.area());
        System.out.println("A square with side length of " + s.getSide() + " has a perimeter of: " + s.perimeter());
    }
}
